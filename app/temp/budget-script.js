...
function updateProgressBar() {
    // Récupération des valeurs du budget
    const budgetInitial = 1000; // Le budget initial
    const montantConsomme = 1000; // Montant déjà consommé
    const reste = budgetInitial - montantConsomme; // Le reste
    ...
    document.getElementById('budget-initial').textContent = `${budgetInitial} €`;
    document.getElementById('montant-consomme').textContent = `${montantConsomme} €`;
